...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { capitol: @state.capitol, name: @state.name, population: @state.population } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { capitol: @state.capitol, name: @state.name, population: @state.population } }
